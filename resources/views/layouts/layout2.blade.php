    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            @endguest
            <li id="normal-cart">
              <a id="normal-carts" href="//urban-essence.lemonstand.com/cart" data-toggle="dropdown"> <i class="fa fa-shopping-cart"></i>  <span class="hidden-xs" id="navbar-totals">@guest 0 @else{{count($offer)}}@endguest</span> Items</a>
